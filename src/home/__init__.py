...
async def home_page():
    ...
    with ui.row().classes('grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 my-5 w-full'):
        with ui.link(target='/rules').classes('no-underline'):
            with ui.card().tight().classes('no-shadow aspect-square bg-[#512698]'):
                ...
                with ui.column().classes('w-full p-5'):
                    ui.label('Fair play is at the core of our community. '
                        ...
                        .classes('text-lg text-[#ffc82e] px-5 font-mono font-bold')
        with ui.link(target='/register').classes('no-underline'):
            with ui.card().tight().classes('no-shadow aspect-square bg-[#FFC82E]'):
                ...
                with ui.column().classes('w-full p-5'):
                    ui.label("Already understand the rules? Great! "
                        ...
                        .classes('text-lg text-[#512698] px-5 font-mono font-bold')
